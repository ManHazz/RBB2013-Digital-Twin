...
- `nl-command` service + Ollama integration + happy + fail unit tests (Hazieq-01..04)
...
- All 10 interface contract rows filled (Hazieq-05, Ariq-06, Ibrohim-06/FIX-06, Raziq-06)
...
- Hazieq: integration test nl→planner (Hazieq-06), CI pipeline lint/unit/integration/regression (Hazieq-07), golden IK regression suite (Hazieq-08)
